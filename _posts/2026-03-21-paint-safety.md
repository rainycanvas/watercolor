---
layout: post
title: Watercolor Paint 101 - Safety Label
author: RainyCanvas
tags:
- paint
- watercolor
...
<figure style="text-align: center; margin: 2em auto;">
  <img src="/watercolor/assets/img/ap_seal.jpg" alt="Safety Seal labelled on a Watercolor Tube" style="display: block; margin: 0 auto; max-width: 100%; height: 500px;">
  <figcaption style="font-style: italic; margin-top: 0.8em; color: #666;">Safety Seal labelled on a Watercolor Tube</figcaption>
</figure>
...
Even if a tube of paint carries the AP Seal, it is only guaranteed safe under "normal and intended use." For watercolor, that means using a brush to apply paint onto paper. Anything else can carry risks.

- Don’t eat or drink your supplies: It sounds obvious, but accidental ingestion is the biggest risk. Keep your coffee mug far away from your rinse jar. Also, watch your pets, cats are curious to all water containers other than their own.
- Don’t point the brush with your mouth. Avoid using your fingers to shape them as well
- Don't apply the paint on the skin. While skin is a great natural barrier, it isn't perfect. Chemicals can be absorbed through prolonged contact or tiny cuts. some pigments can cause irritation. If you get paint on your hands, wash it off with soap and water as soon as possible.
- Don't airbrush, at least not with properly protection. When you spray paint, you turn it into a fine mist (aerosol) that can be inhaled deep into your lungs.

Also, remember that even for pigments currently labeled as "safe", their long-term health impacts are not always fully understood. Scientific standards evolve, and what we consider safe today might be viewed differently in the future.

<h2>Other than the Pigment</h2>
...
Some manufactors list those associated minerals and by-products in their SDS form, even for trace amount. We are exposed to trace amounts of harmful elements in our daily lives all the time. There is no need to panic or be overly anxious about your paints, but it is better to do your own research and decide for yourself what level of risk you are comfortable with. 
